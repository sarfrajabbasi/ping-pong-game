...
const paddleWidth = 18,
    ...
    paddleSpeed = 8,
    ballRadius = 12,
    initialBallSpeed = 3, // Reduced initial ball speed
    maxBallSpeed = 40,
    netWidth = 5,
    netColor = "white";
...
let ball = { x: canvas.width / 2, y: canvas.height / 2, radius: ballRadius, velocityX: initialBallSpeed, velocityY: initialBallSpeed, color: "white", speed: initialBallSpeed };
